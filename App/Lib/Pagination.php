...
class Pagination extends Model
{
    ...
    {
        $this->links .= "<div class=\"col-sm-12 p-0 mx-auto text-center\"><ul class=\"pagination\">";
    ...
    {
        $this->links .= "<li class='page-item active'><a class='page-link' href='#'>" . $this->getPager() . "</span class='sr-only'></span></a></li>";
    }
    /**
