        ...
        <?php foreach ($key as $value): ?>                   
          ...
          <div class="col-lg-4"> 
            <?php  if(!empty($_SESSION['msg'])): ?>
              ...
              <div class="alert alert-warning my-2 border-0" role="alert"><?= $_SESSION['msg']; ?>       
            ...
            <div class="box-shadow">  
              <div class="position-relative p-0 ">             
                <div id="<?= $value['id_post']; ?>" class="carousel slide" data-ride="carousel">
                  ...
                  <?php if($value['id_user'] !== $_SESSION['user']): ?>  
                    <div class="col text-white bg-success">
                      <blockquote class=" btn-sm py-2"><b>Você é o Freelancer</b></blockquote>             
                    </div>
                  <?php else: ?>
                    <div class="col text-white bg-success">
                      <blockquote class=" btn-sm py-2"><b>Você é o Anfritrião</b></blockquote>             
                    </div>  
                  <?php endif; ?>   
