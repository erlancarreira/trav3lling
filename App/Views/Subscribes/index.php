              ...
              <div class="bg my-3 p-3 box-shadow ">
                  <div class="row">
                    <div class="col-lg-2 position-relative">
                      ...
                      <div class="" style="position: absolute; bottom: 28px;"> 
                        <button type="submit" name="inbox" class="btn btn-primary border-0 text-white font-weight-bold"><i class="fa fa-comment mr-2" aria-hidden="true"></i>Inbox</button>  
                            ...
                            <div class="col-lg-10">
                                ...
                                <ul class="list-unstyled d-flex justify-content-between" style="height: 100%;">   
                                  <div class="d-flex">  
                                    <li class="">
                                      <blockquote class="mr-2">Skills</blockquote> 
                                    <?php if (!empty($value['skills'])) : ?>      
                                     <?php foreach ($value['skills'] as $skill): ?>  
                                       <p class="mr-2 btn-sm btn btn-success text-capitalize" style="color: white !important;"><?= $skill['name']; ?></p>
                                     <?php endforeach; ?>
                                    <?php endif ?>  
                                    ...
                                    <li class="">  
                                      ...
                                      <?php foreach ($value['languages'] as $languages): ?>  
                                       <p class="mr-2 btn-sm btn btn-warning text-capitalize"><?= $languages['name']; ?></p>
                                     <?php endforeach; ?>
                                    <?php endif ?> 
                                    </li>
